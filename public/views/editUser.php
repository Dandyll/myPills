    ...
    <div class = "pillsearch">
        <section class="usrEdit">
            ...
            <form action="addpill" method="POST" ENCTYPE="multipart/form-data">
                ...
                ?>
                <input name="ageEdit" type="text" placeholder="age">
                <input name="sexEdit" type="text" placeholder="sex">
                <input name="phoneEdit" type="text" placeholder="phone">
                <input name="bloodEdit" type="text" placeholder="blood">
                <input name="weightEdit" type="text" placeholder="weight">
                <input name="birth_dateEdit" type="text" placeholder="birth_date">
...
<script type="text/javascript" src="public/js/usrDet.js"></script>
